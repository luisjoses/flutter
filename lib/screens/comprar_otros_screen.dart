...
class ComprarOtrosScreen extends StatelessWidget {
  const ComprarOtrosScreen({super.key});
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: 'Conejos', child: Text('Conejos')),
                              DropdownMenuItem(value: 'Caballos', child: Text('Caballos')),
                              DropdownMenuItem(value: 'Burros', child: Text('Burros')),
                      ...
                      return FutureBuilder<Map<String, List<double>>>(
                        ...
                        builder: (context, cpSnapshot) {
                          ...
                          return FutureBuilder<QuerySnapshot>(
                            future: FirebaseFirestore.instance.collection('otros_ofertas').get(),
