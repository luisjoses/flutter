...
class ComprarOvejasScreen extends StatelessWidget {
  const ComprarOvejasScreen({super.key});
  ...
  Future<Map<String, List<double>>> cargarCPsCoords() async {
    ...
    for (var line in lines) {
      ...
      if (parts.length >= 5) {
        ...
        map[cp] = [lat, lon];
        // Omitimos logs detallados de CP invÃ¡lidos para reducir ruido
      }
    }
    // Log resumido opcional eliminado
    return map;
  }
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: 'Merina', child: Text('Merina')),
                              DropdownMenuItem(value: 'Churra', child: Text('Churra')),
                              DropdownMenuItem(value: 'Manchega', child: Text('Manchega')),
                      ...
                      return FutureBuilder<Map<String, List<double>>>(
                        ...
                        builder: (context, cpSnapshot) {
                          ...
                          return FutureBuilder<QuerySnapshot>(
                            future: FirebaseFirestore.instance.collection('ovejas_ofertas').get(),
                                              ...
                                              MaterialPageRoute<Widget>(
                                                builder: (context) => DetalleOfertaScreen(
                                                  oferta: {
                                                    ...oferta,
                                                    'coleccion':
                                                        'ovejas_ofertas', // <-- AÃ±ade la colecciÃ³n aquÃ­
                                                  },
                                                  fotos: fotos,
                                                ),
                                              ),
