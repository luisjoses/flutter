...
class ComprarCabrasScreen extends StatelessWidget {
  const ComprarCabrasScreen({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              DropdownMenuItem(child: Text('Todas')),
                              DropdownMenuItem(value: 'Murciana', child: Text('Murciana')),
                              DropdownMenuItem(value: 'Malague̱a', child: Text('Malague̱a')),
                              DropdownMenuItem(value: 'Florida', child: Text('Florida')),
                              DropdownMenuItem(value: 'Payoya', child: Text('Payoya')),
                              DropdownMenuItem(
                                  value: 'Blanca Andaluza', child: Text('Blanca Andaluza')),
                              DropdownMenuItem(value: 'Guadarrama', child: Text('Guadarrama')),
                              DropdownMenuItem(value: 'Majorera', child: Text('Majorera')),
                              DropdownMenuItem(value: 'Palmera', child: Text('Palmera')),
                      ...
                      return FutureBuilder<Map<String, List<double>>>(
                        ...
                        builder: (context, cpSnapshot) {
                          ...
                          return FutureBuilder<QuerySnapshot>(
                            future: FirebaseFirestore.instance.collection('cabras_ofertas').get(),
