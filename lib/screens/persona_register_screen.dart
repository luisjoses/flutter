...
class PersonaRegisterScreen extends StatefulWidget {
  const PersonaRegisterScreen({super.key});

  @override
  State<PersonaRegisterScreen> createState() => _PersonaRegisterScreenState();
}

class _PersonaRegisterScreenState extends State<PersonaRegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    if (!_aceptaTerminos) {
      setState(() {
        _error = AppLocalizations.of(context).t('acceptTerms');
      });
      return;
    }
    if (_passwordController.text != _password2Controller.text) {
      setState(() {
        _error = AppLocalizations.of(context).t('passwordsMismatch');
      });
      return;
    }
    try {
      ...
      setState(() {
        _success = AppLocalizations.of(context).t('registerSuccess');
      });
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(_nombreController,
                      bi ? AppLocalizations.bilingual('name') : loc.t('name'), true),
                  _buildTextField(_apellidosController,
                      bi ? AppLocalizations.bilingual('lastName') : loc.t('lastName'), true),
                  _buildTextField(_dniController,
                      bi ? AppLocalizations.bilingual('dniNie') : loc.t('dniNie'), true),
                  ...
                  _buildTextField(_cpController,
                      ...
                      maxLength: 5, type: TextInputType.number),
                        ...
                        child: Wrap(
                          children: [
                            Text(bi
                                ...
                                : loc.t('acceptTerms')), // simplified acceptance text
                            GestureDetector(
                              onTap: () {
                                showDialog<void>(
                                  context: context,
      ...
      child: SizedBox(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: Colors.white, // Fondo blanco para inspirar confianza
          ),
          validator: (value) {
            final loc = AppLocalizations.of(context);
...
// Widget para mostrar los t̩rminos y condiciones largos
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Scrollbar(
        ...
        child: SingleChildScrollView(
          controller: _scrollController,
          child: Text(AppLocalizations.of(context).t('termsBody')),
        ),
      ),
    );
  }
